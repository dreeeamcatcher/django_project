...
class RegistrationForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['first_name'].label = 'Имя пользователя'
        self.fields['last_name'].label = 'Фамилия пользователя'
        self.fields['email'].label = 'Ваша почта'
        self.fields['email'].help_text = 'Пожалуйста, указывайте реальный адрес електронной почты'
    ...
    def clean(self):
        ...
        if User.objects.filter(email=email).exists():
            raise forms.ValidationError('Пользователь с таким почтовым адресом уже зарегистрирован!')
